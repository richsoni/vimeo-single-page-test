...
module.exports = React.createClass({
  ...
  render: function(){
    return <div style={this.props.style}>
      <div style={{fontSize: '2em'}}>Created By: <a style={this._style.link} href={this.props.creator_url}>{this.props.creator_display_name}</a> in {moment(this.props.created_on).format('YYYY')}</div>
